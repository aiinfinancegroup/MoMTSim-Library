...
import org.momtsim.utils.ResourceUtils;
...
public class Parameters {
    ...
    public Parameters(String propertiesFile) {
        ...
        try (InputStream inputStream = ResourceUtils.open(propertiesFile)) {
            props.load(inputStream);
        } catch (IOException e) {
            throw new IllegalArgumentException(String.format("error loading properties file: %s", propertiesFile), e);
        }
